...
export function Screener() {
  ...
  // 按当前资产类型过滤策略预设, 避免股票/ETF 切换时误清策略池
  ...
  useEffect(() => {
    ...
    if (!asOf || strategyPresets.length === 0 || runAll.isPending || visiblePool.length === 0) return
  ...
  }, [asOf, strategyPresets.length, visiblePool, extColumnsParam, cacheCoversPool, screenerAutoRun, activeStrategy, applyRunAllResult])
